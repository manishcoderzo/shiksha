                            ...
                            <div class="countries-list">
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/usa.png') }}" alt="" width="35">
                                    </div>
                                ...
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/india.png') }}" alt=""
                                            width="35">
                                    </div>
                                    <div class="country-name flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/china.png') }}" alt=""
                                            width="35">
                                    </div>
                                    <div class="country-name flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/russia.png') }}" alt=""
                                            width="35">
                                    </div>
                                    <div class="country-name flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/australia.png') }}" alt=""
                                            width="35">
                                    </div>
                                    <div class="country-name flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-3">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/brazil.png') }}" alt=""
                                            width="35">
                                    </div>
                                    <div class="country-name flex-grow-1">
                                ...
                                <div class="d-flex align-items-center gap-3 mb-0">
                                    <div class="country-icon">
                                        <img src="{{ asset('assets/images/icons/UAE.png') }}" alt=""
                                            width="35">
                                    </div>
                                    <div class="country-name flex-grow-1">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row g-4 align-items-center mb-4">
                                <div class="col-12 col-xl-4">
                                    ...
                                    <p class="mb-0">In publishing and graphic design, Lorem ipsum is a placeholder text
                                ...
                                <table class="table table-borderless align-middle mb-0">
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="country-icon">
                                                    <img src="{{ asset('assets/images/icons/usa.png') }}" alt=""
                                                        width="32">
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="country-icon">
                                                    <img src="{{ asset('assets/images/icons/russia.png') }}"
                                                        alt="" width="32">
                                                </div>
                                            </td>
                                            <td>
