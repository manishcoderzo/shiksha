    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary" onclick="window.location='{{route('superadmin.adminCreate')}}'">Add</button>
            </div>
            <form method="get">
            <div class="row">
                    <div class="col-lg-4">
                    ...
                    <div class="table-responsive mt-2">
                        ...
                        <table class="table align-middle mb-0" id="myTable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>{{$key++ +1}}</td>
                                    <td>{{$d->blockList->blockName}}</td>
                                    <td>{{$d->fname}} {{$d->lname}}</td>
                                    <td>{{$d->phone}}</td>
                                    <td>{{$d->email}}</td>
                                    <td>
                                        @if($d->photo != '' && file_exists(public_path().'/superadmin/admin/'.$d->photo))
                                        <img src="{{asset('superadmin/admin/'.$d->photo)}}" alt="" width="50" height="50" class="rounded-circle">
                                        @else
                                        <img src="{{asset('assets/images/noimage.png')}}" alt="" width="50" height="50" class="rounded-circle">
                                        @endif
                                    </td>
                                    <td>
                                        @if($d->status == '1')
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3 fs-6">
                                            ...
                                            <a href="{{route('superadmin.adminEdit',[$d->id])}}" class="text-warning" data-bs-toggle="tooltip"
                                                data-bs-placement="bottom" title=""
                                                data-bs-original-title="Edit info" aria-label="Edit">
                                                <ion-icon name="pencil-outline"></ion-icon>
                                            </a>
                                            <a href="{{route('superadmin.admindelete',[$d->id])}}" class="text-danger" data-bs-toggle="tooltip"
