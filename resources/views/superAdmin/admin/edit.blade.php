                    ...
                    <form class="row g-3" action="{{route('superadmin.adminUpdate',[$data->id])}}" method="post" enctype="multipart/form-data">
                      ...
                      <div class="col-4">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" id="perCreate" name="perCreate">
                            <option selected  disabled>Option..</option>
                            <option value="0" {{ $data->perCreate == '0' ? 'selected' : ''}}>No</option>
                            <option value="1" {{ $data->perCreate == '1' ? 'selected' : ''}}>Yes</option>
                        </select>
                        @error('perCreate')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      ...
                      <div class="col-4">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" id="perView" name="perView">
                            <option selected  disabled>Option..</option>
                            <option value="0" {{ $data->perView == '0' ? 'selected' : ''}}>No</option>
                            <option value="1" {{ $data->perView == '1' ? 'selected' : ''}}>Yes</option>
                        </select>
                        @error('perView')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      ...
                      <div class="col-4">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" id="perEdit" name="perEdit">
                            <option selected  disabled>Option..</option>
                            <option {{ $data->perEdit == '0' ? 'selected' : ''}} value="0">No</option>
                            <option {{ $data->perEdit == '1' ? 'selected' : ''}} value="1">Yes</option>
                        </select>
                        @error('perEdit')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                      ...
                      <div class="col-4">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" id="PerDelete" name="PerDelete">
                            <option selected  disabled>Option..</option>
                            <option {{ $data->PerDelete == '0' ? 'selected' : ''}} value="0">No</option>
                            <option {{ $data->PerDelete == '1' ? 'selected' : ''}} value="1">Yes</option>
                        </select>
                        @error('PerDelete')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
