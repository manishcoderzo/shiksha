                ...
                <li class="nav-item dropdown dropdown-user-setting">
                    <a class="nav-link dropdown-toggle dropdown-toggle-nocaret" href="javascript:;"
                        ...
                        <div class="user-setting">
                            ...
                            <img src="{{asset('superadmin/profileImage/'.auth('web')->user()->photo)}}" class="user-img">
                            @else
                            <img src="{{asset('assets/images/noimage.png')}}" class="user-img">
                            @endif
                        </div>
                    </a>
                        ...
                        <li>
                            <a class="dropdown-item" href="javascript:;">
                                <div class="d-flex flex-row align-items-center gap-2">
                                    @if(auth('web')->user()->photo != '' && file_exists(public_path().'/superadmin/profileImage/'.auth('web')->user()->photo))
                                    <img src="{{asset('superadmin/profileImage/'.auth('web')->user()->photo)}}" class="rounded-circle" width="54" height="54">
                                    @else
                                    <img src="{{asset('assets/images/noimage.png')}}" class="rounded-circle" width="54" height="54">
                                    @endif
                                   <!--  <img src="{{ asset('assets/images/avatars/06.png') }}" alt=""
                                        class="rounded-circle" width="54" height="54"> -->
                                    <div class="">
                                        <h6 class="mb-0 dropdown-user-name">{{auth('web')->user()->fname}} {{auth('web')->user()->lname}}</h6>
