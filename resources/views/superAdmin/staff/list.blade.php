    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="row">
                    ...
                    <div class="col-lg-4">
                        <p>School</p>
                        <select class="select" id="title" name="school" placeholder="Pick a School...">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-3 fs-6">
                                            <a href="{{route('superadmin.staffView',[$d->id])}}" class="text-primary" data-bs-toggle="tooltip"
            ...
            @else
            <h5>Super Admin Not Permission to View the Staff List</h5>
            @endif
        </div>
        <!-- end page content-->
    </div>
