    ...
    <div class="page-content-wrapper">
        ...
        <div class="page-content">
            ...
            <div class="d-flex justify-content-end">
                <button class="btn btn-primary" onclick="window.location='{{route('superadmin.headmasterCreate')}}'">Add</button>
            </div>

            <div class="card radius-10 w-100">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <h6 class="mb-0">Headmaster List</h6>
            ...
            @else
            <h5>Super Admin Not Permission to View the Headmaster List</h5>
            @endif
        </div>
        <!-- end page content-->
    </div>
