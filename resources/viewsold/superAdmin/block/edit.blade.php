            ...
            <div class="mt-2">
                <div class="card">
                  <div class="card-body">
                    ...
                    <h6 class="mb-0 text-uppercase">Block Edit</h6>

                     <hr>
                    <form class="row g-3" action="{{route('blockUpdate',[$data->id])}}" method="post">
                        @csrf
                      <div class="col-4">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" id="state" name="stateId">
                            ...
                            @foreach($state as $s)
                            <option value="{{$s->state_id}}" {{ $data->stateId == $s->state_id ? 'selected' : ''}}>{{$s->state_title}}</option>
                            @endforeach
                        </select>
                      </div>
                      <div class="col-4">
                        ...
                        <select class="form-select mb-3" aria-label="Default select example" id="district" name="districtid">
                            ...
                            <option value="{{$d->districtid}}" {{ $data->districtid == $d->districtid ? 'selected' : ''}}>{{$d->district_title}}</option>
                            @endforeach
                        </select>
                      </div>
                      ...
                      <div class="col-4">
                        ...
                        <input type="text" class="form-control" name="blockName" value="{{$data->blockName}}">
                      </div>
